...
### Слой Presenter
Презентер реализован в src/index.ts. Он организует связь между моделями, представлением, API и модальными окнами, обрабатывает событие и вызывает метод модели для изменения данных, а также запускает рендер при изменении данных.
